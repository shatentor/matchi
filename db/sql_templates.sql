...
CREATE TABLE IF NOT EXISTS users (
    ...
    age_lower_point INTEGER, -- <-- Изменено
    age_high_point INTEGER,  -- <-- Изменено
...
CREATE TABLE IF NOT EXISTS stickers (
    id SERIAL PRIMARY KEY, -- <-- Изменено
...
CREATE TABLE IF NOT EXISTS messages (
    ...
    timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP, -- <-- Изменено
